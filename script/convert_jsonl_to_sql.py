...
def main():
    ...
    with open(INPUT_FILE, 'r', encoding='utf-8') as infile, \
        ...
        outfile.write("-- timetableId를 lecture_timetable.id로 그대로 사용하여 관계를 맺습니다.\n\n")
        ...
        for line in infile:
            ...
            try:
                ...
                for meeting in meetings:
                    # meeting_id는 AUTO_INCREMENT 사용
                    sql_schedule = (
                        "INSERT IGNORE INTO lecture_schedule "
                        "(lecture_id, meeting_day, start_time, end_time, building_room) "
                        "VALUES ("
                        f"{timetable_id}, "  # 부모 ID (FK: lecture_timetable.id)
                ...
                for elig in eligibilities:
                    # eligibility_id는 AUTO_INCREMENT 사용
                    sql_eligibility = (
                        "INSERT IGNORE INTO lecture_eligibility "
                        "(lecture_id, department_name, category_type) "
                        "VALUES ("
