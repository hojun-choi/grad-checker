...
# --- [Industrial & Information Systems Engineering] 설정 ---
DEPARTMENT = "industrial"
# ---

def get_post_links(driver, old_post_ids, max_pages_to_scan):
    
    # URL에 오타(cummunity)가 포함되어 있으니 주의 (실제 사이트 반영)
    BASE_URL_TEMPLATE = "https://iise.ssu.ac.kr/cummunity/notice/page/{page_num}/?term_id"
