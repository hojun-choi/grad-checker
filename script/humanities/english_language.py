...
# --- [English Language] 설정 ---
DEPARTMENT = "english_language"
# ---

def get_post_links(driver, old_post_ids, max_pages_to_scan):
    
    # 영어영문학과 공지사항 페이지네이션 URL 구조
    # HTML 소스 상의 href 참조 (대학원/공지사항 경로)
    BASE_URL_TEMPLATE = "https://englan.ssu.ac.kr/%eb%8c%80%ed%95%99%ec%9b%90/%ea%b3%b5%ec%a7%80%ec%82%ac%ed%95%ad/page/{page_num}/?term_id"
        ...
        for page_num in range(1, max_pages_to_scan + 1):
            ...
            for row in rows:
                ...
                post_data = {
                    ...
                    "title": title,
                    "author": "N/A", # 영어영문학과 목록에도 작성자 정보 없음
                    "date": date,
                    "link": link,
                }
