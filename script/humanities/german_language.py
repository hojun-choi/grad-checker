...
# --- [German Language] 설정 ---
DEPARTMENT = "german_language"
# ---

def get_post_links(driver, old_post_ids, max_pages_to_scan):
    
    # 독어독문학과 공지사항 페이지네이션 URL 구조
    # 한글 경로: https://gerlan.ssu.ac.kr/학과사무실알림/공지사항/page/{page_num}/?term_id
    BASE_URL_TEMPLATE = "https://gerlan.ssu.ac.kr/%ed%95%99%ea%b3%bc%ec%82%ac%eb%ac%b4%ec%8b%a4%ec%95%8c%eb%a6%bc/%ea%b3%b5%ec%a7%80%ec%82%ac%ed%95%ad/page/{page_num}/?term_id"
        ...
        for page_num in range(1, max_pages_to_scan + 1):
            ...
            for row in rows:
                ...
                post_data = {
                    ...
                    "title": title,
                    "author": "N/A", # 독어독문학과 목록에도 작성자 정보 없음
                    "date": date,
                    "link": link,
                }
