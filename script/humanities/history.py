...
def get_post_links(driver, old_post_ids, max_pages_to_scan):
    ...
    # 사학과 공지사항 페이지네이션 URL 구조
    # 한글 경로: https://history.ssu.ac.kr/학과소식/학과공지/page/{page_num}/?term_id
    BASE_URL_TEMPLATE = "https://history.ssu.ac.kr/%ed%95%99%ea%b3%bc%ec%86%8c%ec%8b%9d/%ed%95%99%ea%b3%bc%ea%b3%b5%ec%a7%80/page/{page_num}/?term_id"
