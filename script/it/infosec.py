...
def get_post_links(driver, old_post_ids, max_pages_to_scan):
    """
    숭실대학교 정보보호학과 공지사항 게시판에서 게시글 링크와 메타데이터를 수집합니다.
    (computer.py 와 HTML 구조가 동일하여 로직을 그대로 사용합니다.)
    """
    
    # 정보보호학과 공지사항 URL 템플릿
    BASE_URL_TEMPLATE = "https://sec.ssu.ac.kr/bbs/board.php?bo_table=notice&page={page_num}"
    
    # computer.py 와 선택자가 동일합니다.
