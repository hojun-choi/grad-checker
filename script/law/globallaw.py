...
# --- [Global Law] 설정 ---
DEPARTMENT = "globallaw"

def get_post_links(driver, old_post_ids, max_pages_to_scan):
    BASE_URL_TEMPLATE = "https://lawyer.ssu.ac.kr/%ed%95%99%ea%b3%bc-%ec%86%8c%ec%8b%9d/%ed%95%99%ea%b3%bc-%ea%b3%b5%ec%a7%80/page/{page_num}/?term_id"
    ...
    try:
        for page_num in range(1, max_pages_to_scan + 1):
            ...
            for row in rows:
                ...
                # 새 형식에 맞게 데이터 구성 (작성자는 목록에 없으므로 'N/A')
                post_data = {
