...
# --- [Liberal Study] 설정 ---
DEPARTMENT = "liberal_study"
BASE_DOMAIN = "https://sls.ssu.ac.kr" # 숭실대학교 자유전공학부 도메인

def get_post_links(driver, old_post_ids, max_pages_to_scan):
    """
    숭실대학교 자유전공학부 공지사항 게시판에서 게시글 링크와 메타데이터를 수집합니다.
    """
    
    # 자유전공학부 공지사항 URL 템플릿
    # 1페이지는 URL이 다릅니다.
    URL_PAGE_1 = "https://sls.ssu.ac.kr/%ed%95%99%eb%b6%80%ec%86%8c%ec%8b%9d/%ea%b3%b5%ec%a7%80%ec%82%ac%ed%95%ad/"
    BASE_URL_TEMPLATE = "https://sls.ssu.ac.kr/%ed%95%99%eb%b6%80%ec%86%8c%ec%8b%9d/%ea%b3%b5%ec%a7%80%ec%82%ac%ed%95%ad/page/{page_num}/?term_id"
