...
#기본적으로 각 학과별 크롤링은 다음과 같음.
#마지막으로 저장된 게시글이 새로운 게시글과 동일할 때 크롤링 종료.
#아니라면 새로운 게시글이 동일할때까지 크롤링 진행. 
try:
    #인문대학
    ...
    from it import computer
    from it import electronic_engineering
    from it import global_media
    from it import ai_convergence
    from it import infosec
    
    #차세대반도체
    from next_gen_semiconductor import next_gen_semiconductor

    #자유전공
    from liberal_study import liberal_study
