...
def get_post_links(driver, old_post_ids, max_pages_to_scan):
    ...
    # 화학과 공지사항 페이지네이션 URL 구조
    # 한글 URL 경로: https://chem.ssu.ac.kr/공지사항/page/{page_num}/?term_id
    BASE_URL_TEMPLATE = "https://chem.ssu.ac.kr/%ea%b3%b5%ec%a7%80%ec%82%ac%ed%95%ad/page/{page_num}/?term_id"
    
    # HTML 소스 분석에 따른 선택자 설정
    # class="table_wrap baord_table" (오타 baord 유지)
    LIST_ROW_SELECTOR = ".baord_table tbody > tr"
    NUM_SELECTOR = "td:nth-of-type(1)"
    TITLE_SELECTOR = "td.title a"
    DATE_SELECTOR = "td:nth-of-type(4)" # 번호, 제목, 파일, '등록일', 조회수
