...
def get_post_links(driver, old_post_ids, max_pages_to_scan):
    ...
    # 물리학과 공지사항 페이지네이션 URL 구조
    # HTML 소스 상의 href를 참조: .../page/{page_num}/?term_id
    BASE_URL_TEMPLATE = "https://physics.ssu.ac.kr/%ea%b2%8c%ec%8b%9c%ed%8c%90/%ea%b3%b5%ec%a7%80%ec%82%ac%ed%95%ad/page/{page_num}/?term_id"
        ...
        for page_num in range(1, max_pages_to_scan + 1):
            ...
            for row in rows:
                ...
                post_data = {
                    ...
                    "title": title,
                    "author": "N/A", # 물리학과 목록에도 작성자 정보 없음
                    "date": date,
                    "link": link,
                }
